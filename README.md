# PolicyChanges waifu2x
waifu2x with some ease of life addons

download yt video before upscaling example: 
	runWaifu.sh -d <youtube URL>
	
remove previous scaling files for upscaling a different video:
	runWaifu.sh -r
