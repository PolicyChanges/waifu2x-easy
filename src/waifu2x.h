...
public:
    ...
    Waifu2x(std::string setFilename, int gpuid, bool tta_mode = false, int num_threads = 1);
    ~Waifu2x();
    ...
    int process(const ncnn::Mat& inimage, ncnn::Mat& outimage, const std::string filename) const;
